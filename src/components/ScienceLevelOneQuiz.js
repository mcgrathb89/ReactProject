...
import QuizQuestions from "../api/ScienceLevelOneQuestions";
import Quiz from "./Quiz";
import Result from "./Result";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class ScienceLevelOneQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        incorrectResponsesCourseLink="/mainpage/lvl-one-science"
        mixedResponsesCourseLink="/mainpage/lvl-one-science"
        correctResponsesCourseLink="/mainpage/lvl-two-science"
...
export default ScienceLevelOneQuiz;
