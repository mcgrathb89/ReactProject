...
import QuizQuestions from "../api/EnglishLevelTwoQuestions";
import Quiz from "./Quiz";
import Result from "./MediumResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class EnglishLevelTwoQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        correctResponseCourseLink="/mainpage/lvl-three-english"
        incorrectResponseCourseLink="/mainpage/lvl-one-english"
        currentCourseLink="/mainpage/lvl-two-english"
...
export default EnglishLevelTwoQuiz;
