...
import QuizQuestions from "../api/GeneralLevelTwoQuestions";
import Quiz from "./Quiz";
import Result from "./MediumResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class GeneralLevelTwoQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        correctResponseCourseLink="/mainpage/lvl-three-general"
        incorrectResponseCourseLink="/mainpage/lvl-one-general"
        currentCourseLink="/mainpage/lvl-two-general"
...
export default GeneralLevelTwoQuiz;
