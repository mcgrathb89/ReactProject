...
import QuizQuestions from "../api/GeneralLevelThreeQuestions";
import Quiz from "./Quiz";
import Result from "./AdvancedResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class GeneralLevelThreeQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderQuiz() {
    return (
      <Quiz
        ...
        link="/mainpage/lvl-three-general"
      />
    );
  }
  ...
  renderResult() {
    return (
      <Result
        ...
        incorrectResponseCourseLink="/mainpage/lvl-two-general"
        currentCourseLink="/mainpage/lvl-three-general"
...
export default GeneralLevelThreeQuiz;
