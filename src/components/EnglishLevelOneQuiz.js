...
import QuizQuestions from "../api/EnglishLevelOneQuestions";
import Quiz from "./Quiz";
import Result from "./Result";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class EnglishLevelOneQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        incorrectResponsesCourseLink="/mainpage/lvl-one-english"
        mixedResponsesCourseLink="/mainpage/lvl-one-english"
        correctResponsesCourseLink="/mainpage/lvl-two-english"
...
export default EnglishLevelOneQuiz;
