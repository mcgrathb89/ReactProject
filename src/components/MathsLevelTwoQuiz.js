...
import QuizQuestions from "../api/MathsLevelTwoQuestions";
import Quiz from "./Quiz";
import Result from "./MediumResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class MathsLevelTwoQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        correctResponseCourseLink="/mainpage/lvl-three-maths"
        incorrectResponseCourseLink="/mainpage/lvl-one-maths"
        currentCourseLink="/mainpage/lvl-two-maths"
...
export default MathsLevelTwoQuiz;
