...
import QuizQuestions from "../api/GeneralLevelOneQuestions";
import Quiz from "./Quiz";
import Result from "./Result";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class GeneralLevelOneQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderResult() {
    return (
      <Result
        incorrectResponsesCourseLink="/mainpage/lvl-one-general"
        mixedResponsesCourseLink="/mainpage/lvl-one-general"
        correctResponsesCourseLink="/mainpage/lvl-two-general"
...
export default GeneralLevelOneQuiz;
