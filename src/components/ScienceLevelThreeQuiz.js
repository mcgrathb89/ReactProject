...
import QuizQuestions from "../api/ScienceLevelThreeQuestions";
import Quiz from "./Quiz";
import Result from "./AdvancedResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class ScienceLevelThreeQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderQuiz() {
    return (
      <Quiz
        ...
        link="/mainpage/lvl-three-science"
      />
    );
  }
  ...
  renderResult() {
    return (
      <Result
        ...
        incorrectResponseCourseLink="/mainpage/lvl-two-science"
        currentCourseLink="/mainpage/lvl-three-science"
    ...
    return (
      <div id="main" fluid>
        ...
        <div className="quizTitle">
          <h1>Level Three Science Quiz</h1>
        </div>
...
export default ScienceLevelThreeQuiz;
