...
import QuizQuestions from "../api/EnglishLevelThreeQuestions";
import Quiz from "./Quiz";
import Result from "./AdvancedResult";
import Navbar from "./Navbar";
import "../styles/_GeneralQuiz.scss";

class EnglishLevelThreeQuiz extends Component {
  constructor(props) {
    super(props);
  ...
  renderQuiz() {
    return (
      <Quiz
        ...
        link="/mainpage/lvl-three-english"
      />
    );
  }
  ...
  renderResult() {
    return (
      <Result
        ...
        incorrectResponseCourseLink="/mainpage/lvl-two-english"
        currentCourseLink="/mainpage/lvl-three-english"
    ...
    return (
      <div id="main" fluid>
        ...
        <div className="quizTitle">
          <h1>Level Three English Quiz</h1>
        </div>
...
export default EnglishLevelThreeQuiz;
